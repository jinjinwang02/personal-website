...
const addAnimeToLinks = (className, index, func, linkIndex) => {
    document.querySelectorAll(className)[index].addEventListener("mouseenter", () => { func(linkIndex) });
};
addAnimeToLinks(".home__contactLinks-item", 0, linkAnime, 1);
addAnimeToLinks(".home__contactLinks-item", 1, linkAnime, 2);
addAnimeToLinks(".home__contactLinks-item", 2, linkAnime, 3);
addAnimeToLinks(".home__contactLinks-item", 3, linkAnime, 4);
addAnimeToLinks(".footer__contactLinks-item", 0, linkAnime, 1);
addAnimeToLinks(".footer__contactLinks-item", 1, linkAnime, 2);
addAnimeToLinks(".footer__contactLinks-item", 2, linkAnime, 3);
addAnimeToLinks(".footer__contactLinks-item", 3, linkAnime, 4);
